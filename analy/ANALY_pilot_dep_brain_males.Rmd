...
#check males and females breakdown F= 564, M=1074
targetdata %>% 
  dplyr::count(sex)
...
#save as .csv
#global
write.csv(ROI_dep_brain_males_bulk_results,file= "../results/revised_pilot/tables/ROIs_dep_brain_global_males.csv")
