...
#get mean age and sd for pilot sample. Mean age = 9.94, SD = 0.61
...
#global results
result.males.dep_brain.bulk$Sig <- as.numeric((as.character(result.males.dep_brain.bulk[,"p.value"]))) < 0.01

#regional results
result.males.dep_brain.region.covWholeB$Sig <- as.numeric((as.character(result.males.dep_brain.region.covWholeB[,"p.value"]))) < 0.01

#Save results as .csv files

#global results
write.csv(result.males.dep_brain.bulk, file = '../results/revised_pilot/tables/pilot_males.dep_brain.bulk.csv')

#regional results 
write.csv(result.males.dep_brain.region.covWholeB, file = '../results/revised_pilot/tables/pilot_males_dep_brain.regional.csv')
...
ROI_dep_brain_males_bulk_results <- result.males.dep_brain.bulk %>%
  filter(p.value <0.01)
...
#save as R.data
save(ROI_dep_brain_males_regional_results,ROI_dep_brain_males_bulk_results,file='../results/revised_pilot/ROIs_dep_brain_males.RData')

#save as .csv
write.csv(ROI_dep_brain_males_regional_results,file= "../results/revised_pilot/tables/ROIs_dep_brain_males.csv")
