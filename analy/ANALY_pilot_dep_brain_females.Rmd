...
Covariates Covariates: covari_cleaned_R3.0.rds
...
```{r, variable classification}
 ...
 df %>% 
 select("sex", "race.6level", "age_years", "scanner_id", "rel_family_id") %>% 
  str()
```
...
source('../functions/mixed_effects_models.R')
...
ls.models$covs=paste0(c('age_years','rel_family_id','race.6level','scanner_id'),collapse='+')
