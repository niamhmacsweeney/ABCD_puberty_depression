...
Depression measures are indexed in two ways:
  1. Depression symptom severity (continuous measure: (0-15 continuous scale). =              KSADS.Dep_symptoms_sum_ever
...
ls.factor=colnames(targetdata)[grep('^KSADS\\.Dep_symptoms_sum_ever|^KSADS\\.Depressive_symptoms_ever',
                                    colnames(targetdata))]
