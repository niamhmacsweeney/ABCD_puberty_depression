...
IGNORE for pilot analysis — we will not nest the random factors due to model convergence issues but the code below gives us an insight into the nested structure of the data. 
...
####STEP 2: Generate female only dataframe from related baseline sample. 
...
#Get Female sample only N= 5675
targetdata <- targetdata %>%
  filter(sex == "F")

```

Check minimum sample size as we are using complete case analysis in lme models. 
N= 4537

```{r, check complete cases}

sum(complete.cases(targetdata)) #N= 4537
