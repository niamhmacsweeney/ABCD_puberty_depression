...
#ABCD Pilot Analysis Script - Males
...
#Save as R.Data file
save(result.males.PT_brain.bulk,result.males.PT_brain.region.covWholeB,file='../results/PT_males_brain_pilot_analysis.RData')
...
ROI_males_regional <- result.males.PT_brain.region.covWholeB %>% 
