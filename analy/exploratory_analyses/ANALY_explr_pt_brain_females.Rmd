...
#Don't control for WBV in exploratory analyses - that uses basic model. 
...
#Save as R.Data file
save(result.females.pt_brain.bulk,result.females.pt_brain.region,file='/Volumes/GenScotDepression/users/niamh/puberty_ABCD/ABCD_puberty_depression/results/exploratory_analysis/females_pt_brain_explr.RData')
...
CCfitBase <- lmer(SA.glb ~ pt_f + age_y3 + race_y0
                            + (1|site_id) + (1|fam_id),
