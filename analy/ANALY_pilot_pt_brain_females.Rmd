...
#Note that these DTI measures: CC, fmaj and fmin are also unilateral, so these need to be listed here too. 
...
#Save as R.Data file
save(result.females.pt_brain.bulk,result.females.pt_brain.region.covWholeB,file='../results/revised_pilot/females_pt_brain_pilot.RData')

#add TRUE column if nominal p value < 0.005 for pilot ROIs

#global results
result.females.pt_brain.bulk$Sig <- as.numeric((as.character(result.females.pt_brain.bulk[,"p.value"]))) < 0.01

#regional results
result.females.pt_brain.region.covWholeB$Sig <- as.numeric((as.character(result.females.pt_brain.region.covWholeB[,"p.value"]))) < 0.01

#Save results as .csv files

#global results
write.csv(result.females.pt_brain.bulk, file = '../results/revised_pilot/tables/pilot_females.pt_brain.bulk.csv')
...
ROI_pt_brain_females_bulk_results <- result.females.pt_brain.bulk %>%
  filter(p.value <0.01)
...
#save as R.data
save(ROI_pt_brain_females_regional_results,file='../results/revised_pilot/ROIs_pt_brain_females.RData')

#save as .csv
write.csv(ROI_pt_brain_females_regional_results, file = "../results/revised_pilot/tables/ROIs_pt_brain_females.csv")
