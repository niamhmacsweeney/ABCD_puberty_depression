...
To Do: Make demographics table for breakdown of different pubertal stages 
...
USER: Make sure that the model names specified below match the model names defined in function (i.e., it should say bilateral below and in the PhewasStyle_Random function script)
...
#Global (bulk) models
result.females.pt_brain.global=reg_phewasStyle(ls.model.bulk,dat_short=targetdata,dat_long=dat_long,correctByFactor = T)
...
#Save as R.Data file
save(result.females.pt_brain.global,result.females.pt_brain.region.covWholeB,file='../results/revised_pilot/females_pt_brain_pilot.RData')
...
#global results
result.females.pt_brain.global$Sig <- as.numeric((as.character(result.females.pt_brain.global[,"p.value"]))) < 0.02

#regional results
result.females.pt_brain.region.covWholeB$Sig <- as.numeric((as.character(result.females.pt_brain.region.covWholeB[,"p.value"]))) < 0.02

#Save results as .csv files

#global results
write.csv(result.females.pt_brain.global, file = '../results/revised_pilot/tables/pilot_females.pt_brain.global.csv')

#regional results 
write.csv(result.females.pt_brain.region.covWholeB, file = '../results/revised_pilot/tables/pilot_females.pt_brain.regional.csv')



#
#regional results 
write.csv(result.females.pt_brain.region.covWholeB, file = '../results/revised_pilot/tables/pilot_females_pt_brain.regional.csv')
...
ROI_pt_brain_females_global_results <- result.females.pt_brain.global %>%
  filter(p.value <0.02)
...
#save as R.data
save(ROI_pt_brain_females_regional_results, ROI_pt_brain_females_global_results, file='../results/revised_pilot/ROIs_pt_brain_females.RData')

#save as .csv
#global
write.csv(ROI_pt_brain_females_global_results, file = "../results/revised_pilot/tables/ROIs_pt_brain_global_females.csv")



#regional
write.csv(ROI_pt_brain_females_regional_results, file = "../results/revised_pilot/tables/ROIs_pt_brain_regional_females.csv")
