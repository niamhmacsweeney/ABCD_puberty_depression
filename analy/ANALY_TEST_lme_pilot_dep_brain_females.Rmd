...
ls.dep.fs.long=colnames(dat_long)[grep('dtifa\\_|dtimd\\_',colnames(dat_long))] #select vars of interest
...
ls.dep.all=ls.dep.all[c(grep('dtifa\\_|dtimd\\_',ls.dep.all))]
...
ls.model.region.covWholeB$covs[grep('dtifa\\_|dtimd\\_',ls.model.region.covWholeB$dependent)]=
      paste0(ls.model.region.covWholeB$covs[grep('dtifa\\_|dtimd\\_',ls.model.region.covWholeB$dependent)])


#thk\\.','sa\\.','vol\\.APARC','sulc\\.', 'dtifa\\_','dtimd\\_
