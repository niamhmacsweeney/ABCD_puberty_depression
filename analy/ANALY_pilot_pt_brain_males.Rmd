...
#add TRUE column if nominal p value < 0.01 for pilot ROIs

#global results
result.males.pt_brain.global$Sig <- as.numeric((as.character(result.males.pt_brain.global[,"p.value"]))) < 0.01
