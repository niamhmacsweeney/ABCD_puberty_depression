...
write.table(test_tbl,"/Volumes/GenScotDepression/users/niamh/puberty_ABCD/ABCD_puberty_depression/results/main_analysis/resCCfitBase_males.txt", sep="\t",row.names=FALSE)
...
#Full model
MIfitFull <- with(data = ModImps, exp = glmer(cbcl_withdep_y3 ~ pt_m + age_y3 + race_y0 + bmi_y1 + household_income_y0 +
                                              parent_dep_y2 + (1|site_id_y1) + (1|rel_family_id),
