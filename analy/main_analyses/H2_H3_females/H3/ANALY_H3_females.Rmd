...
```{r, run H2}
runModels("/Volumes/GenScotDepression/users/niamh/puberty_ABCD/MplusAuto/females/H3", 
          replaceOutfile="modifiedDate")

#extract all model output info from 
H3Output <- readModels(
            "/Volumes/GenScotDepression/users/niamh/puberty_ABCD/MplusAuto/females/H3",
             recursive=TRUE)
...
#### H3a ####
H3aResults <- H3indirect$female_H3a.out$indirect$unstandardized
H3aResults
...
### H3b ###
H3bResults <- H3indirect$female_H3b.out$indirect$unstandardized
H3bResults     
...
H3cResults <- H3indirect$female_H3c.out$indirect$unstandardized
H3cResults     
...
H3dResults <- H3indirect$female_H3d.out$indirect$unstandardized
H3dResults     
...
### H3e ###
H3eResults <- H3indirect$female_H3e.out$indirect$unstandardized
H3eResults     
...
H3fResults <- H3indirect$female_H3f.out$indirect$unstandardized
H3fResults     
...
H3gResults <- H3indirect$female_H3g.out$indirect$unstandardized
H3gResults     
...
write.csv(H3resultsAll, "/Volumes/GenScotDepression/users/niamh/puberty_ABCD/MPlusAuto/females/results_tables/H3femaleResults.csv", row.names=TRUE)
...
H3afit <- H3summaryStats$female_H3a.out$summaries

$female_H3a.out$indirect$unstandardized
H3aResults
