...
```{r, plot CC}
#Base
effectSizePlotFemalesBase <- plot_model(CCfitBase, type = "est", ci.style = "bar",  vline.color = "black", dot.size = 3)
effectSizePlotFemalesBase

#Full
effectSizePlotFemalesFull <- plot_model(CCfitFull, type = "est", ci.style = "bar",  vline.color = "black", dot.size = 3)
