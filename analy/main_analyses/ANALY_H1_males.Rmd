...
effectSizePlotMalesBase <- plot_model(CCfitBase, type = "est", ci.lvl=0.95, ci.style = "bar",  vline.color = "black", dot.size = 3)
effectSizePlotMalesBase

#Full

effectSizePlotMales <- plot_model(CCfitFull, type = "est", ci.lvl=0.95, ci.style = "bar",  vline.color = "black", dot.size = 3)
effectSizePlotMales
