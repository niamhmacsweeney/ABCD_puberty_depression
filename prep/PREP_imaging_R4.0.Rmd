...
We will use intracranial volume (ICV) as a covariate in our regional measure models but not in our global measure models. ABCD have derived a measure of ICV that we will use but we will rename it to just "ICV". 

```{r, change ICV variable name}

t1$ICV = t1$vol.ASEG.intracranialv
