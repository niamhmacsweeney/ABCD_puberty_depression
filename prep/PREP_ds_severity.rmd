...
ABCD data: [release 2.0.1](https://nda.nih.gov/data_dictionary.html?source=ABCD%2BRelease%2B3.0&submission=ALL)
...
library(dplyr)
library(knitr)
tab.dat.dir='/Volumes/GenScotDepression/data/abcd/release2.0.1/iii.data'
```
...
sum_dep_measures <- targetdat.clean %>% 
  select (KSADS.MDD.y, KSADS.MDD.p, KSADS.Dep_symptoms_sum_ever.y, KSADS.Dep_symptoms_sum_ever.p, KSADS.Depressive_symptoms_ever.y, KSADS.Depressive_symptoms_ever.p)

setwd("/Volumes/GenScotDepression/users/niamh/puberty_ABCD/ABCD_puberty_depression/data")

saveRDS(sum_dep_measures,"ABCD_release_201_sum_dep_measures.rds")


```
 
Get breakdown of MDD and DS for caregiver and child report. 
Note missing data for DS (~30%) and MDD (~14%)
```{r}
